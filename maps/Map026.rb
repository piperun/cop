  ...
  "events" => [
    {
      ...
      "pages" => [
        {
          "conditions" => [],
          "graphic" => { "character" => "064-Beast02", "tile" => 0, "opacity" => 255, "blend" => 0, "hue" => 0, "pattern" => 0, "direction" => 6 },
          "move_type" => 1,
          "move_speed" => 3,
          "move_frequency" => 5,
          "move_animation" => true,
    ...
    },
    {
      ...
      "pages" => [
        {
          "conditions" => [],
          "graphic" => { "character" => "064-Beast02", "tile" => 0, "opacity" => 255, "blend" => 0, "hue" => 0, "pattern" => 0, "direction" => 4 },
          "move_type" => 1,
          "move_speed" => 3,
          "move_frequency" => 5,
          "move_animation" => true,
    ...
    },
    {
      ...
      "pages" => [
        {
          "conditions" => [],
          "graphic" => { "character" => "064-Beast02", "tile" => 0, "opacity" => 255, "blend" => 0, "hue" => 0, "pattern" => 0, "direction" => 2 },
          "move_type" => 1,
          "move_speed" => 3,
          "move_frequency" => 5,
          "move_animation" => true,
    ...
    },
    {
      ...
      "pages" => [
        {
          "conditions" => [],
          "graphic" => { "character" => "064-Beast02", "tile" => 0, "opacity" => 255, "blend" => 0, "hue" => 0, "pattern" => 0, "direction" => 8 },
          "move_type" => 1,
          "move_speed" => 3,
          "move_frequency" => 5,
          "move_animation" => true,
      ...
      "pages" => [
        ...
        },
        {
          ...
          "commands" => <<-COMMANDS
            ...
            screen_tone(0,0,0,0,duration=20)
            script $game_screen.weather(5, 20, 10, 0)
            wait 30
            moveroute()
              speed(2)
              move forward
        ...
        },
        {
          ...
          "commands" => <<-COMMANDS
            ...
            text [\N[1]]
                 ...
                 It's so peaceful...)
            text [\N[1]]
                 (Not even a sight of monsters here...)
            script $pose.clear
                   $pose = nil
            script $pose = Pose.new("A","A","A03",0,0)
                   $pose.pop
            text [\N[1]]
                 (The chaotic aura can't affect this area?)
            script $pose.clear
                   $pose = nil
            moveroute()
              unknown45
