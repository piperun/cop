  ...
  "events" => [
    ...
    },
    {
      ...
      "pages" => [
        {
          "conditions" => [],
          "graphic" => { "character" => "bandit3_01", "tile" => 0, "opacity" => 255, "blend" => 0, "hue" => 0, "pattern" => 0, "direction" => 2 },
          "move_type" => 0,
          "move_speed" => 3,
          "move_frequency" => 3,
          "move_animation" => true,
    ...
    },
    {
      ...
      "pages" => [
        {
          "conditions" => [],
          "graphic" => { "character" => "bandit1_01", "tile" => 0, "opacity" => 255, "blend" => 0, "hue" => 0, "pattern" => 0, "direction" => 4 },
          "move_type" => 0,
          "move_speed" => 3,
          "move_frequency" => 3,
          "move_animation" => true,
    ...
    },
    {
      ...
      "pages" => [
        {
          "conditions" => [],
          "graphic" => { "character" => "Prisoner02", "tile" => 0, "opacity" => 255, "blend" => 0, "hue" => 0, "pattern" => 0, "direction" => 2 },
          "move_type" => 0,
          "move_speed" => 3,
          "move_frequency" => 3,
          "move_animation" => true,
